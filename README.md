...
<!-- AUTO-GENERATED by scripts/build.py on 2026-09-15 10:10 UTC — DO NOT EDIT the lists below manually. Edit papers/*.yaml or blogs/*.yaml and run `python3 scripts/build.py` instead. -->
